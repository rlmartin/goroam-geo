  ...
  module ActsAsMappable 
    ...
    module ClassMethods # :nodoc:
      ...
      def acts_as_mappable(options = {})
        ...
        cattr_accessor :distance_column_name, :default_units, :default_formula, :lat_column_name, :lng_column_name, :lat_lng_table_name, :qualified_lat_column_name, :qualified_lng_column_name
        self.distance_column_name = options[:distance_column_name]  || 'distance'
        self.default_units = options[:default_units] || GeoKit::default_units
        self.default_formula = options[:default_formula] || GeoKit::default_formula
        self.lat_column_name = options[:lat_column_name] || 'lat'
        self.lng_column_name = options[:lng_column_name] || 'lng'
        # Ryan Martin added this to allow for joining to other tables for lat/lng
        self.lat_lng_table_name = options[:lat_lng_table_name] || self.table_name
        self.qualified_lat_column_name = "#{lat_lng_table_name}.#{lat_column_name}"
        self.qualified_lng_column_name = "#{lat_lng_table_name}.#{lng_column_name}"
